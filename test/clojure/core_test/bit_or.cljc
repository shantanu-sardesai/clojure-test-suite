...
(when-var-exists bit-or
  (deftest test-bit-or
    ...
    (are [ex a b] (= ex (bit-or a b))
      ...
      #?(:cljs -1
         :default r/all-ones-int)           0                        r/all-ones-int
      #?(:cljs -1
         :default r/all-ones-int)           r/all-ones-int           r/all-ones-int
      #?(:cljs -1
         :default r/all-ones-int)           r/full-width-checker-pos r/all-ones-int
      #?(:cljs -1
         :default r/all-ones-int)           r/full-width-checker-pos r/full-width-checker-neg)))
